...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sprintd "gobject list" output
    ...
    def sprintd_serialise(self):
        import sprintlib
        return sprintlib.SHIM_serialise_for_sprintd(self.serialise())
